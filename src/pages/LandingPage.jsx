...
const LandingPage = () => {
  ...
  const handleGithubSignUp = () => {
    window.location.href = '/signup-with-github';
  };
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto !my-4 text-[20px] max-w-[600px] text-gray-500">
                  Join our community of motivated individuals and start tracking your work consistency today.
                </p>
              </div>
              <Button className="inline-flex items-center justify-center bg-[#24292e]" size="lg" onClick={handleGithubSignUp}>
                <Github className="mr-2 h-4 w-4" />
